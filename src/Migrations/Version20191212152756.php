 ...
 */
final class Version20191212152756 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advert ADD category VARCHAR(255) DEFAULT \'0\' NOT NULL, DROP category_id');
    }
