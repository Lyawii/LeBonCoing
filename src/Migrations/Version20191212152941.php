 ...
 */
final class Version20191212152941 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advert ADD category_id INT NOT NULL, DROP category');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advert ADD category VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'\'\'1\'\'\' NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP category_id');
    }
}
